...
HD_PWD='C:/Users/abhi/OneDrive/Desktop/project/half_adder/half_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log R_adder_seventeen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source R_adder_seventeen.tcl -notrace
