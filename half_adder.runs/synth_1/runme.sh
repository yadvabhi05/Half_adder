...
HD_PWD='C:/Users/abhi/OneDrive/Desktop/project/half_adder/half_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log R_adder_seventeen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source R_adder_seventeen.tcl
